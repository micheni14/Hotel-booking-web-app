      ...
      <div className=" container mx-auto w-full  px-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <p className="text-white font-semibold text-2xl">Zero Hustle</p>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-white dark:text-white font-medium">
                <li className="cursor-pointer hover:underline">Resorts</li>
                <li className="cursor-pointer hover:underline">Vilas</li>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-white sm:text-center dark:text-white">
            © 2024 Zero Hustle . All Rights Reserved.
          </span>
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            <a
              href="#"
              className="text-white hover:underline dark:hover:text-white"
            >
              <svg
                className="w-4 h-4"
                aria-hidden="true"
